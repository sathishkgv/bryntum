import { Container, StringHelper, WidgetHelper, ProjectModel, TaskModel, DependencyModel, TreeGrid, BryntumWidgetAdapterRegister, Collection } from '../../build/gantt.module.js?433978';
...
const gantt = container.widgetMap.gantt,
...
actionsGrid.on({
    selectionchange : ({ mode, selected, deselected }) => {
        if (mode === 'row') {
