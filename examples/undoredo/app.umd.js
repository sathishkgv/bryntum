...
var gantt = container.widgetMap.gantt,
    ...
    actionStore = actionsGrid.store; // Obtaining State Tracking Manager instance we will be using to track tasks and dependencies store state.

var stm = gantt.project.stm; // Disabling State Tracking Manager initially to not record normalization transaction
