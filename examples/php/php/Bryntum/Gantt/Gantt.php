...
class Gantt extends \Bryntum\CRUD\BaseDAO
{
    ...
    public function removeTask($id)
    {
        ...
        foreach ((array)$children as $subTask) {
            ...
            $this->removedRows['tasks'][$subTask['id']] = ['id' => $subTask['id']];
        }
    ...
    public function getCalendarIntervals($where = null)
    {
        ...
        if (!$stmt->execute($values)) {
            throw new Exception('Cannot get calendar intervals list.', E_APP_GET_CALENDAR_INTERVALS);
        }
    ...
    public function removeCalendarIntervals($data)
    {
        ...
        if (!$stmt->execute($values)) {
            throw new Exception("Cannot remove calendar #$data.", E_APP_REMOVE_CALENDARINTERVALS);
        }
    ...
    public function removeCalendar($id, $force = false)
    {
        ...
        if (!$this->db->query("delete from calendars where id = $id")) {
            throw new Exception("Cannot remove calendar #$id.", E_APP_REMOVE_CALENDAR);
        }
    ...
    public function removeResource($id, $force = false)
    {
        ...
        if (!$this->db->query("delete from resources where id = $id")) {
            throw new Exception("Cannot remove resource #$id.", E_APP_REMOVE_RESOURCE);
        }
    ...
    public function removeAssignment($id)
    {
        ...
        if (!$this->db->query("delete from assignments where id = $id")) {
            throw new Exception("Cannot remove assignment #$id.", E_APP_REMOVE_ASSIGNMENT);
        }
    ...
    public function removeDependency($id)
    {
        ...
        if (!$this->db->query("delete from dependencies where id = $id")) {
            throw new Exception("Cannot remove dependency #$id.", E_APP_REMOVE_DEPENDENCY);
        }
    ...
    public function removeTimeRange($id)
    {
        ...
        if (!$this->db->query("delete from time_ranges where id = $id")) {
            throw new Exception("Cannot remove time range #$id.", E_APP_REMOVE_TIME_RANGE);
        }
    ...
    public function getTimeRanges($where = null)
    {
        ...
        if (!$stmt->execute($values)) {
            throw new Exception('Cannot get time range list.', E_APP_GET_TIME_RANGES);
        }
