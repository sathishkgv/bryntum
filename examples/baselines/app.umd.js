  ...
  features: {
    baselines: {
      template: function template(data) {
        ...
        return "\n                    <div class=\"b-gantt-task-title\">".concat(task.name, " (baseline ").concat(baseline.parentIndex + 1, ")</div>\n                    <table>\n                    <tr><td>").concat(me.L('Start'), ":</td><td>").concat(data.startClockHtml, "</td></tr>\n                    ").concat(baseline.milestone ? '' : "\n                        <tr><td>".concat(me.L('End'), ":</td><td>").concat(data.endClockHtml, "</td></tr>\n                        <tr><td>").concat(me.L('Duration'), ":</td><td class=\"b-right\">").concat(displayDuration + ' ' + bryntum.gantt.DateHelper.getLocalizedNameOfUnit(baseline.durationUnit, baseline.duration !== 1), "</td></tr>\n                    "), "\n                    </table>\n                    ").concat(delayed ? "\n                        <h4 class=\"statusmessage b-baseline-delay\"><i class=\"statusicon b-fa b-fa-exclamation-triangle\"></i>Delayed start by ".concat(bryntum.gantt.DateHelper.formatDelta(task.startDate - baseline.startDate), "</h4>\n                    ") : '', "\n                    ").concat(overrun ? "\n                        <h4 class=\"statusmessage b-baseline-overrun\"><i class=\"statusicon b-fa b-fa-exclamation-triangle\"></i>Overrrun by ".concat(bryntum.gantt.DateHelper.formatDelta(task.durationMS - baseline.durationMS), "</h4>\n                    ") : '', "\n                    ");
      }
    },
    columnLines: false,
    filter: true,
