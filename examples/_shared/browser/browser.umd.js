  ...
  _createClass(ExamplesApp, [{
    ...
    value: function render() {
      ...
      if (examplesThumbsContainerEl.children.length === 0) {
        ...
        examplesThumbsContainerEl.innerHTML = me.template({
          examples: examples
        });
      } else {
      ...
      bryntum.gantt.WidgetHelper.attachTooltip(examplesThumbsContainerEl, {
