...
(function() {
    const targetElement = document.querySelector('div[data-file="scheduler/ResourceInfoColumn.js"] .external-target');
...
// scheduler with basic configuration
    let scheduler = new Scheduler({
        ...
        columns : [
            { type: 'resourceInfo', field : 'name', text : 'Name', imagePath :  window.location.host.includes('bryntum') ? '/examples/scheduler/_shared/images/users/' : '../examples/_shared/images/users/' }
        ],

        resources : [
            { id : 1, name : 'Bernard', image : 'arnold.jpg' },
            { id : 2, name : 'Bianca', image : 'gloria.jpg' }
        ],
