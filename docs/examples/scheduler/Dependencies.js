...
(function() {
    const targetElement = document.querySelector('div[data-file="scheduler/Dependencies.js"] .external-target');

    // User may already have navigated away from the documentation part that shows the example
    if (!targetElement) return;

    targetElement.innerHTML = '<p>This demo draws dependencies between some events using the Dependencies feature. Double click to edit a dependency.</p>';
//START
