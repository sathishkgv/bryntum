...
StartTest(function (t) {
  var gantt,
      lineFeature,
      statusDate = new Date(2019, 1, 4); // In some tests we do live updates of the view and try to use common assertion methods which rely on data.
  ...
  function assertTaskLines(t, task) {
    ...
    var scrollLeft = gantt.scrollLeft,
        ...
        statusLineX = (statusDateX === -1 ? gantt.timeAxisViewModel.totalWidth : statusDateX) - scrollLeft + gantt.subGrids.normal.element.getBoundingClientRect().left,
  ...
  function _setup() {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee11(config) {
          ...
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              gantt = t.getGantt(Object.assign({
                ...
                taskRenderer: function taskRenderer(_ref12) {
                  var taskRecord = _ref12.taskRecord,
                      tplData = _ref12.tplData;
  ...
  t.it('Tasks are reachable under progress line',
  /*#__PURE__*/
  function () {
  ...
  t.it('Progress line should react on task store events',
  /*#__PURE__*/
  function () {
  ...
  t.it('Progress line should react to view changes',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should draw line correctly on vertical scroll',
  /*#__PURE__*/
  function () {
  ...
  t.it('Progress line is updated on drag',
  /*#__PURE__*/
  function () {
      ...
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              assertLineIsTop = function _ref7() {
                var box = t.getSVGBox(lineEl);
                t.is(document.elementFromPoint(box.left, box.top), lineEl, 'Line is on top');
              };
  ...
  t.it('Progress line works properly on a large time axis',
  /*#__PURE__*/
  function () {
  ...
  t.it('Progress line could be changed',
  /*#__PURE__*/
  function () {
