import { ProjectModel } from '../../build/gantt.module.js?433978';

StartTest(t => {
    let gantt, lineFeature, statusDate = new Date(2019, 1, 4);
    ...
    function processLineBox(el) {
        let currentLineBox = t.getSVGBox(el),
            result         = {
    ...
    function assertTaskLines(t, task) {
        ...
        let scrollLeft  = gantt.scrollLeft,
    ...
    t.it('Progress line is updated on drag', async t => {
        ...
        t.chain(
            ...
            { mouseUp : null },
            { drag : '.b-gantt-task.id15', by : [gantt.tickWidth * 7, 0], dragOnly : true },
            next => {
