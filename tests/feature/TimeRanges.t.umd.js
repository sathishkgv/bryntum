...
StartTest(function (t) {
  ...
  t.it('Should show time ranges from the project timeRangeStore', function (t) {
    ...
    t.chain({
      ...
      t.selectorCountIs('.b-grid-headers .b-nonworkingtime', 4, '4 weekends in header');
      t.selectorCountIs('.b-grid-headers .b-sch-timerange.b-sch-range', 4, '4 weekend range elements in header');
