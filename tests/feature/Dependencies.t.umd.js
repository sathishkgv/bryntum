...
StartTest(function (t) {
  ...
  t.it('Aborting creating dependency shouldn\'t throw an exception in Gantt',
  /*#__PURE__*/
  function () {
  ...
  t.it('Validating dependencies while D&D', function (t) {
    gantt = t.getGantt({
      appendTo: document.body,
      features: {
        taskTooltip: false
    ...
    var oldUpdateTipContent = gantt.features.dependencies.updateTipContent;

    gantt.features.dependencies.updateTipContent = function (tip, data) {
      if (data.valid instanceof Promise) {
        var origPromise = data.valid;
        data.valid = new Promise(function (resolve) {
          origPromise.then(function (valid) {
            setTimeout(function () {
              resolve(valid);
            }, 500);
          });
      ...
      return oldUpdateTipContent.call(gantt.features.dependencies, tip, data);
    };
  ...
  t.it('Should not cancel edit when editing a new dependency',
  /*#__PURE__*/
  function () {
