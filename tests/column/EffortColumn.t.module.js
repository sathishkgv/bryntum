import { DurationColumn, EffortColumn, DateHelper } from '../../build/gantt.module.js?433978';
    ...
    t.it('Should use the same value for column rendering and editor', (t) => {
        ...
        t.chain(
            ...
            (next, clickedCellEl) => {
                ...
                t.is(editorInputEl.value, clickedCellEl.innerHTML, 'Editor value is correct');
            }
        );
    });
