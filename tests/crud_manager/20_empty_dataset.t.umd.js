...
StartTest(function (t) {
  ...
  t.it('CRUD manager shouldn\'t sync an empty dataset',
  /*#__PURE__*/
  function () {
            ...
            case 2:
              ...
              project.on({
                'beforesync': function beforesync(_ref2) {
                  ...
                  //     ...
                  // }
                  t.ok(!pack.hasOwnProperty('resources'), 'Crud manager doesn\'t sync unchanged resources');
                  t.ok(!pack.hasOwnProperty('tasks'), 'Crud manager doesn\'t sync unchanged tasks');
                  t.endAsync(async);
                  return false;
                },
                single: true
