...
.x-gecko .filterfield .x-form-trigger {
    display : table-cell;
}

.filterfield .x-form-trigger-wrap-default {
    border : 0;
}
...
/*
 * IE 11 shows a clear-field cross
   http://stackoverflow.com/questions/20473413/remove-ie11s-clear-field-x-button-on-windows-8
*/
.filterfield input::-ms-clear {
    display : none;
    width   : 0;
    height  : 0;
}body > .x-splitter-vertical div {
    display : none;
}
...
.tr-vertical-align-helper-content {
...
.resultPanel-panel,
.resultPanel-panel > .x-panel-body {
    border : 0 none;
}

.resultpanel-testtitle {
    white-space : nowrap;
    overflow    : hidden;
    line-height : 48px; /*prevent text from clipping vertically */
}

.test-source-ct .syntaxhighlighter {
    overflow : hidden !important;
}

.si-sourcepanel-close {
    width    : 14px;
    height   : 14px;
    position : absolute;
    top      : 2px;
...
.test-source-ct .toolbar {
    display : none;
}

/* fixes row height sync in Chrome */
...
.resultPanel-panel > .x-panel-body > .x-splitter-vertical div {
    display : none;
}
...
.siesta-test-initializing .x-grid-item-container:empty::after {
    font-family : FontAwesome;
    content     : "\f250    Initializing...";
    padding     : 8px 14px;
    display     : block;
}

.siesta-assertion-grid .x-grid-cell-inner {
}

.siesta-assertion-grid {
    border-bottom : 0 none;
}

.siesta-assertion-grid td {
    border-width : 0;
}
...
.tr-tree-column .x-grid-cell-inner {
    position : relative;
}
...
.tr-summary-row .x-tree-icon,
.tr-summary-row .x-tree-elbow-empty,
.tr-summary-row .x-tree-elbow-end {
    display : none !important;
}

.tr-summary-row .x-grid-cell {
    padding-left : 10px;
}

.tr-summary-row .x-tree-node-text {
    padding-left : 0;
}

.tr-summary-row .x-grid-cell-inner {
    margin     : 15px 17px 6px 7px;
...
.si-hide-passes .tr-assertion-row-passed {
    display : none;
}

.siesta-assertion-grid .x-grid-cell-inner img {
    vertical-align : middle;
}
...
.changelog-window .light-button .x-btn-inner {
    color       : #ffffff;
...
.changelog-window .x-window-body {
    background : #fff;
}
...
.st-cov-report-tree-panel .x-toolbar {
    padding-top : 3px;
}

.st-cov-report-tree-panel .x-grid-cell {
    padding : 0 4px;
    border  : 0 none !important;
}

.st-cov-report-tree-panel .x-grid-cell-inner {
    padding-bottom : 2px;
}

.st-cov-report-tree-panel .x-grid-row-selected .cov-result-cell {
    background : transparent !important;
}

.st-cov-report-tree-panel .x-tree-icon {
    background-size : 16px 16px !important;
    border-radius   : 16px;
}

.st-cov-report-tree-panel .x-btn {
    background-image : none !important;
}
...
.st-cov-level-low .x-grid-cell-inner {
    border-bottom : 4px solid #ff1111 !important;
    font-weight   : 300;
}

.st-cov-report-tree-panel .x-tree-icon:before
{
    content:'';
}
...
/* EOF Styles from Istanbul */.pln { color : #333 }
...
.x-grid-tree-node-leaf .action-level-0 .x-tree-elbow-img,
.siesta-recorderpanel-typecolumn .x-tree-icon {
    display : none;
}
...
.siesta-recorderpanel-action-icon-column .x-grid-cell-inner {
    padding-left  : 1px;
    padding-right : 1px;
}
.recorder-toolbar input {
    padding : 0 5px;
}

.siesta-recorderpanel .x-grid-item-container {
    /* Required for code editor to show its full height (it's taller than row height) */
    overflow : visible;
}
...
.siesta-recorderpanel-actioncolumn .step-icon {
    font-size   : 10px;
    margin      : 0 1px;
    width       : 10px;
    cursor      : pointer;
...
.siesta-recorderpanel-actioncolumn .icon-delete-row {
    font-size : 11px;
}
...
.icon-record {
    color : red;
}.siesta-recorder-codeeditor .CodeMirror {
}

.siesta-recorder-codeeditor.siesta-invalid-syntax .CodeMirror:before {
...
.resultpanel-toolbar .testaction-button,
.x-ie9m .resultpanel-toolbar .testaction-button * {
    background : none !important;
    border     : 0 none;
}

.resultpanel-toolbar .x-btn-glyph,
.x-ie9m .resultpanel-toolbar .x-btn-glyph {
...
.resultpanel-toolbar .x-btn-wrap-default-toolbar-medium.x-btn-split-right:after {
    color: #fff;
}

.resultpanel-toolbar .x-btn-wrap-default-toolbar-medium.x-btn-split-right:hover:after {
    color: #ddd;
}

.resultpanel-toolbar .x-btn-pressed .x-btn-glyph {
    color : #81D4FA;
}
...
.siesta-test-title {
    ...
    font-size   : 1.4em;
    font-weight : bold;
    text-shadow : 0 1px rgba(55, 55, 55, 0.5);
}

.x-btn.rerun-button {
    background-image    : none;
    background-color    : rgb(89, 205, 82);
    border-color        : #00a164;
}
...
.x-btn.rerun-button .x-btn-inner {
    color : #fff;
}

.x-btn.rerun-button:hover,
.x-btn.rerun-button.x-btn-pressed {
...
.siesta-domcontainer {
    background : #fff url(../images/domcontainer-bg.png) repeat;
    box-shadow : inset 3px 3px 4px #dfdfdf;
}

.domcontainer-console input {
    color        : #666;
    background   : #fff url(../images/prompt.png) no-repeat 4px center;
    font         : 14px "Consolas";
    border-color : #ccc;
    box-shadow   : 0 1px 3px 0 rgba(150, 150, 150, 0.2) inset, 0 1px 0 rgba(255, 255, 255, 0.2);
}
...
.tr-iframe-wrapper .tr-close:hover {
    color            : #eee;
}
...
.filterfield .x-form-trigger:hover {
    color      : #666;
}
...
/* EOF Styles from Istanbul *//* ICONS AND TEXT */
.test-name-cell span.x-tree-node-text {
    font-size : 14px;
}

.test-name-cell-parent .x-tree-node-text{
    font-weight : 600;
}
...
}.siesta .eventview-target-xy {
    /* warn user that this is a potential issue */
    font-weight : bold;
    color       : #ff8186;
}

.eventview-targetcolumn .modifierkeys {
    font-size : 75%;
    position  : relative;
    top       : -4px;
}