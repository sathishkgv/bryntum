...
StartTest(function (t) {
  ...
  t.it('Should localize dependency type in PredecessorsTab',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should localize dependency type in DependencyField',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should localize dependency type in DependencyTypePicker',
  /*#__PURE__*/
  function () {
