...
StartTest(function (t) {
  t.it('Should be possible to provide store instance during project creation',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should be possible to use `tasksData` config',
  /*#__PURE__*/
  function () {
  ...
  t.it('Project STM must have 5 stores initially',
  /*#__PURE__*/
  function () {
