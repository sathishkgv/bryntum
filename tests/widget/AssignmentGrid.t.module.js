import { AssignmentGrid, MinimalProject } from '../../build/gantt.module.js?433978';
...
StartTest((t) => {
    ...
    t.it('Should render properly', async(t) => {
        ...
        const Arcady = resourceStore.getById(1),
            ...
            [arcadyInput] = t.query('div[data-index=0] div[data-column=assigned] input[type=checkbox]'),
        ...
        const Nick = resourceStore.getById(8),
            ...
            [nickInput] = t.query('div[data-index=7] div[data-column=assigned] input[type=checkbox]'),
        ...
        const Don = resourceStore.getById(2),
            ...
            [donInput] = t.query('div[data-index=1] div[data-column=assigned] input[type=checkbox]'),
    ...
    t.it('Should be possible to bulk assign/unassign resources', async(t) => {
        ...
        const [assignAllCb] = t.query('.b-grid-headers .b-assignmentgrid-assign-all-column .b-checkbox input');
        ...
        t.ok(grid.store.areNoneAssigned, 'Store reports all resources are unassigned');
