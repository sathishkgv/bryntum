...
StartTest(function (t) {
  ...
  function _createTimeLine() {
    _createTimeLine = _asyncToGenerator(
    /*#__PURE__*/
  ...
  t.it('Should size row height based on available subGrid body height',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should show timeline start / end even if no tasks are marked showInTimeline',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should refresh on new task added',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should refresh on task removed',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should refresh on task showInTimeline updated',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should refresh on task start/duration/ updated',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should extend timeline if new task appears outside current range',
  /*#__PURE__*/
  function () {
