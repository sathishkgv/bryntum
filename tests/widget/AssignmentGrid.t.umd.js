...
StartTest(function (t) {
  ...
  var getProject = function getProject() {
    return new MinimalProject(t.getProjectData());
  };

  t.it('Should render properly',
  /*#__PURE__*/
  function () {
  ...
  t.it('Should be possible to bulk assign/unassign resources',
  /*#__PURE__*/
  function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              _t$query19 = t.query('.b-grid-headers .b-assignmentgrid-assign-all-column .b-checkbox input'), _t$query20 = _slicedToArray(_t$query19, 1), assignAllCb = _t$query20[0];
            ...
            case 11:
              ...
              t.ok(grid.store.areAllAssigned, 'Store reports all resources are assigned'); // Now let's unassign all by bulk assignment/unassignment checkbox
            ...
            case 15:
              ...
              t.ok(grid.store.areNoneAssigned, 'Store reports all resources are unassigned'); // Now let's assugn all by bulk assignment/unassignment checkbox
            ...
            case 21:
              ...
              t.ok(grid.store.areAllAssigned, 'Store reports all resources are assigned');
  ...
  t.it('Should be possible to edit assignment units',
  /*#__PURE__*/
  function () {
