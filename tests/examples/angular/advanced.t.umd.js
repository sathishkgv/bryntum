 ...
 * @Last Modified time: 2019-05-27 21:08:51
 * 
 * Advanced Angular demo test
 * 
 * cSpell: ignore zoomchange, timeaxischange, nonworkingtime
 */
describe('Test buttons', function (t) {
  var panel = bryntum.query('panel'),
  ...
  t.it('Gantt should fill the whole width of container', function (t) {
    var gantt = document.querySelector('.b-panel-content'),
